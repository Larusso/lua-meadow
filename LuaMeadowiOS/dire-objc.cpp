...
static int _wrap_new_Mediator(lua_State* L) {
  int SWIG_arg = 0;
  DWMediatorImpl *result = 0 ;
  
  SWIG_check_num_args("DWMediatorImpl::DWMediatorImpl",0,0)
  result = (DWMediatorImpl *)new DWMediatorImpl();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_DWMediatorImpl,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_Mediator_release(lua_State* L) {
  int SWIG_arg = 0;
  DWMediatorImpl *arg1 = (DWMediatorImpl *) 0 ;
  
  SWIG_check_num_args("DWMediatorImpl::release",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DWMediatorImpl::release",1,"DWMediatorImpl *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DWMediatorImpl,0))){
    SWIG_fail_ptr("Mediator_release",1,SWIGTYPE_p_DWMediatorImpl);
  }
...
static int _wrap_Mediator_printType(lua_State* L) {
  ...
  SWIG_check_num_args("DWMediatorImpl::printType",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DWMediatorImpl::printType",1,"DWMediatorImpl *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DWMediatorImpl,0))){
    SWIG_fail_ptr("Mediator_printType",1,SWIGTYPE_p_DWMediatorImpl);
  }
...
static int _wrap_Mediator_move(lua_State* L) {
  ...
  SWIG_check_num_args("DWMediatorImpl::move",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DWMediatorImpl::move",1,"DWMediatorImpl *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DWMediatorImpl::move",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("DWMediatorImpl::move",3,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DWMediatorImpl,0))){
    SWIG_fail_ptr("Mediator_move",1,SWIGTYPE_p_DWMediatorImpl);
  }
...
DWMediatorImpl *arg1 = (DWMediatorImpl *) obj;
delete arg1;
}
static swig_lua_method swig_DWMediatorImpl_methods[] = {
    {"release", _wrap_Mediator_release}, 
    {"printType", _wrap_Mediator_printType}, 
    {"move", _wrap_Mediator_move}, 
    {0,0}
};
static swig_lua_attribute swig_DWMediatorImpl_attributes[] = {
    {0,0,0}
};
static swig_lua_class *swig_DWMediatorImpl_bases[] = {0};
